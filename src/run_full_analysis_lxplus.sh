...
Icentral="/eos/cms/store/group/dpg_bril/comm_bril/2023/physics/" # Path to detector central
Ibeam_central="/eos/cms/store/group/dpg_bril/comm_bril/2023/physics/" # Path to beam central
Ivdm_central="/eos/cms/store/group/dpg_bril/comm_bril/2023/vdm/" # Path to vdM scans central
